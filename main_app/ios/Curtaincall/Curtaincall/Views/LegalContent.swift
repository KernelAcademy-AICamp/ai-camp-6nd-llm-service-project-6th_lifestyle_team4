...
// Legal documents, transcribed from /m/terms.html · /m/privacy.html (시행일 2026-05-29),
// mirroring Android's termsDoc()/privacyDoc() in LegalScreen.kt verbatim.

extension LegalDoc {
    static let terms = LegalDoc(
        barTitle: "이용약관",
        ...
        sections: [
            DocSection(heading: "제1조 (정의)", blocks: [
                .ordered([
                    ...
                    "**\"회원\"**이란 회원가입(이메일·비밀번호 또는 Apple·구글·카카오 등 소셜 계정)을 하여 계정을 보유한 자를 말합니다.",
                    "**\"카드\"**란 명대사, 해당 장면의 극본 발췌, 키워드, 작품 정보 등으로 구성된 콘텐츠 단위를 말합니다.",
                    "**\"콘텐츠\"**란 서비스 내에 게시·제공되는 카드, 텍스트, 이미지, 작품 정보 등 일체의 자료를 말합니다.",
                ]),
            ]),
            DocSection(heading: "제2조 (약관의 게시와 개정)", blocks: [
                .ordered([
            ...
            DocSection(heading: "제3조 (이용계약의 체결)", blocks: [
                .ordered([
            ...
            DocSection(heading: "제4조 (만 14세 미만 아동 등)", blocks: [
                .para("본 서비스는 원칙적으로 만 14세 이상의 이용자를 대상으로 합니다. 만 14세 미만 아동은 법정대리인의 동의를 받아야 하며, 회사는 관련 법령에 따라 이를 처리합니다."),
            ]),
            DocSection(heading: "제5조 (회원 계정 및 관리)", blocks: [
                .ordered([
                    "회원은 이메일·비밀번호 또는 Apple·구글·카카오 등 소셜 계정을 통해 로그인할 수 있습니다.",
            ...
            DocSection(heading: "제6조 (서비스의 제공 및 변경)", blocks: [
                .ordered([
            ...
            DocSection(heading: "제7조 (콘텐츠의 성격 및 AI 생성에 관한 고지)", blocks: [
                .ordered([
            ...
            DocSection(heading: "제8조 (지식재산권)", blocks: [
                .ordered([
            ...
            DocSection(heading: "제9조 (이용자의 의무)", blocks: [
                .para("이용자는 다음 행위를 하여서는 안 됩니다."),
                .ordered([
                    "타인 정보 도용·허위 사실 등록",
            ...
            DocSection(heading: "제10조 (개인정보의 보호)", blocks: [
                .ordered([
                    "개인정보의 수집·이용·보관·파기 등에 관한 사항은 별도의 **개인정보 처리방침**에 따릅니다.",
                    "회사는 서비스 제공·개선을 위하여 회원 식별정보, 북마크 등 이용 기록, 기기·접속 정보 등을 수집·이용할 수 있습니다.",
                    "회사는 운영·분석을 위하여 Supabase 등 제3자 처리위탁·제휴 서비스를 이용할 수 있으며, 관련 사항은 개인정보 처리방침에 명시합니다.",
                ]),
            ]),
            DocSection(heading: "제11조 (이용계약의 해지 및 이용제한)", blocks: [
                .ordered([
            ...
            DocSection(heading: "제12조 (서비스의 중단 및 종료)", blocks: [
                .ordered([
            ...
            DocSection(heading: "제13조 (면책조항)", blocks: [
                .ordered([
            ...
            DocSection(heading: "제14조 (준거법 및 관할)", blocks: [
                .ordered([
    ...
    static let privacy = LegalDoc(
        ...
        sections: [
            DocSection(heading: "1. 수집하는 개인정보 항목", blocks: [
                .sub("가. 회원가입·로그인 시"),
                .unordered([
                    "이메일·비밀번호 가입: 이메일 주소, 비밀번호(암호화 저장)",
                    "소셜 로그인(Apple·구글·카카오): 제공자로부터 전달받는 계정 식별자, 이메일, 프로필 이름 등 이용자가 동의한 항목",
                ]),
                .sub("나. 서비스 이용 과정에서 자동 생성·수집되는 정보"),
                .unordered([
                    "북마크 등 이용자가 저장·생성한 데이터",
                    "기기 정보(OS·브라우저), 접속 IP, 접속 일시, 이용 기록(조회·클릭 등), 쿠키 및 유사 식별자",
                ]),
                .para("비회원(익명 이용자)의 경우 별도 식별정보 없이 브라우저에 저장되는 익명 식별자를 통해 북마크 등이 제공되며, 로그인 시 해당 데이터가 계정으로 연동될 수 있습니다."),
                .sub("다. 의견 보내기(피드백) 이용 시"),
                .unordered([
                    "만족도 별점",
                    "피드백 작성 내용(자유 텍스트)",
                    "선택 입력 성별·연령대",
            ...
            DocSection(heading: "2. 개인정보의 수집·이용 목적", blocks: [
                .unordered([
                    "회원 식별·인증 및 계정 관리",
            ...
            DocSection(heading: "3. 개인정보의 보유 및 이용 기간", blocks: [
                .ordered([
                    "수집·이용 목적 달성 또는 회원 탈퇴 시 해당 개인정보를 지체 없이 파기합니다.",
                    "다만 관계 법령에 따라 보존이 필요한 경우 해당 기간 동안 보관합니다. (예: 접속 기록 — 「통신비밀보호법」에 따라 3개월)",
                ]),
            ]),
            DocSection(heading: "4. 개인정보의 제3자 제공", blocks: [
                .para("회사는 본 방침에 명시한 범위를 넘어 개인정보를 제3자에게 제공하지 않습니다. 다만 이용자가 사전 동의한 경우, 또는 법령에 따라 제출 의무가 있거나 수사기관이 적법한 절차에 따라 요청하는 경우는 예외로 합니다."),
            ]),
            DocSection(heading: "5. 개인정보 처리의 위탁", blocks: [
                .para("회사는 안정적인 서비스 제공을 위하여 다음과 같이 개인정보 처리를 위탁하고 있습니다."),
                .table(
                    headers: ["수탁자", "위탁 업무", "비고"],
                    rows: [
                        ["Supabase", "데이터베이스 저장 및 회원 인증", "국외(해외 리전) 처리될 수 있음"],
                        ["Apple / 구글 / 카카오", "소셜 로그인 인증", "이용자가 선택한 경우에 한함"],
                    ]
                ),
                .para("위 수탁자는 위탁받은 업무 범위 내에서만 개인정보를 처리하며, 회사는 관계 법령에 따라 수탁자를 관리·감독합니다."),
            ]),
            DocSection(heading: "6. 개인정보의 국외 이전", blocks: [
                .para("본 서비스는 위 수탁자(Supabase 등)의 해외 인프라를 이용하므로, 이용자의 개인정보가 국외에서 저장·처리될 수 있습니다. 이용자는 회원가입 및 서비스 이용으로써 이에 동의한 것으로 봅니다."),
            ]),
            DocSection(heading: "7. 쿠키 및 유사 기술의 사용", blocks: [
                .ordered([
            ...
            DocSection(heading: "8. 이용자 및 법정대리인의 권리", blocks: [
                .ordered([
            ...
            DocSection(heading: "9. 개인정보의 안전성 확보 조치", blocks: [
                .para("회사는 비밀번호 암호화, 접근 권한 관리, 전송 구간 암호화(HTTPS) 등 관리적·기술적 보호조치를 취하고 있습니다."),
            ]),
            DocSection(heading: "10. 개인정보 보호책임자 및 문의처", blocks: [
                .unordered([
                    "**서비스명**: Daily Script — 오늘의 명대사",
            ...
            DocSection(heading: "11. 개인정보 처리방침의 변경", blocks: [
                .para("본 방침은 법령·정책 변경에 따라 개정될 수 있으며, 변경 시 시행일 및 변경 내용을 서비스 내에 공지합니다."),
            ]),
        ],
