        ...
        sections: [
            DocSection(heading: "제1조 (정의)", blocks: [
                .ordered([
                    ...
                    "**\"회원\"**이란 회원가입(이메일·비밀번호 또는 Apple·구글 등 소셜 계정)을 하여 계정을 보유한 자를 말합니다.",
            ...
            DocSection(heading: "제5조 (회원 계정 및 관리)", blocks: [
                .ordered([
                    "회원은 이메일·비밀번호 또는 Apple·구글 등 소셜 계정을 통해 로그인할 수 있습니다.",
        ...
        sections: [
            DocSection(heading: "1. 수집하는 개인정보 항목", blocks: [
                ...
                .unordered([
                    ...
                    "소셜 로그인(Apple·구글): 제공자로부터 전달받는 계정 식별자, 이메일, 프로필 이름 등 이용자가 동의한 항목",
                ]),
            ...
            DocSection(heading: "5. 개인정보 처리의 위탁", blocks: [
                ...
                .table(
                    ...
                    rows: [
                        ...
                        ["Apple / 구글", "소셜 로그인 인증", "이용자가 선택한 경우에 한함"],
                    ]
                ),
                .para("위 수탁자는 위탁받은 업무 범위 내에서만 개인정보를 처리하며, 회사는 관계 법령에 따라 수탁자를 관리·감독합니다."),
            ]),
            DocSection(heading: "6. 개인정보의 국외 이전", blocks: [
                .para("본 서비스는 위 수탁자(Supabase, Amplitude, Microsoft Clarity 등)의 해외 인프라를 이용하므로, 이용자의 개인정보가 국외에서 저장·처리될 수 있습니다. 이용자는 회원가입 및 서비스 이용으로써 이에 동의한 것으로 봅니다."),
            ]),
