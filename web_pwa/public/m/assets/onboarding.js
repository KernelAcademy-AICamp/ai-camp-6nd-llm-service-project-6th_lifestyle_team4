...
const STEPS = [
  // ── 홈 화면 ──
  { sel: '.bottom-nav [data-nav="home"]',    scr: '홈',   n: 1, tot: 5, title: 'HOME',            desc: '여기가 홈이에요. 매일 새로운 고전 명대사 한 장이 도착해요.' },
  { sel: '#home-refresh',                    scr: '홈',   n: 2, tot: 5, title: '다른 명대사 보기', desc: '지금 카드가 안 끌리면, 이 버튼을 누를 때마다 다른 명대사로 바뀌어요.' },
  { sel: '#today-bookmark',                  scr: '홈',   n: 3, tot: 5, title: '북마크해 두기',    desc: '마음에 들었다면 이 책갈피를 탭하세요. 나중에 다시 꺼내볼 수 있어요.' },
  { sel: '.bottom-nav [data-nav="archive"]', scr: '홈',   n: 4, tot: 5, title: '내 서재(LIBRARY)', desc: '북마크한 명대사는 여기 LIBRARY에 작품별 책으로 모여요.' },
  { sel: '#today-read',                      scr: '홈',   n: 5, tot: 5, title: '전문 읽으러 가기', desc: '한 줄만으론 아쉽죠. 이 버튼을 누르면 그 장면 전체가 펼쳐져요.', action: 'onOpenDetail' },
  // ── 전문(상세) 화면 ──
