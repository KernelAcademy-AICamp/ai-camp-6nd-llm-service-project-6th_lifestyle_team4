...
[필드 규칙]
- format: "play" 고정
- translator: 번역극인 경우 필수, 창작극은 null
- genres: 아래 13개 중 1~3개 선택
  로맨스, 코미디, 스릴러/서스펜스, 드라마, 비극, 미스터리, 판타지,
  역사극/시대극, 가족극, 액션, 호러, 느와르, SF
- speaker_label:
  · 화자명 + 괄호 안에 짧은 상황 단서 (3~15자)
  · 상황 단서는 *대사를 듣는 사람이 모를 만한 비일상 정보*만:
    예) "에밀리 (죽어서 다시 살아본 후)", "햄릿 (숨어 듣는 자들 앞에서)",
        "클로디어스 (기도 중 일어서며)", "맥베스 (환영을 보며)"
  · 일상적 상황은 괄호 생략: "햄릿", "노라"
...
- script_excerpt: quote 앞뒤 2~5턴 포함, 인물명과 지문 그대로. **최소 2000자 이상** (공백·줄바꿈 포함). 2000자 미만이면 앞뒤 turn을 더 가져와 채울 것.
- excerpt_description: 객관적 장면 설명만, 감상 배제, 500자 이내
- keywords: 정확히 3개. 명사 또는 명사구. 문장·형용사 단독 금지
- temperature: 1(차가움/단절) ~ 3(중립) ~ 5(따뜻함/포용)
- intensity: 1(잔잔함/고요) ~ 3(보통) ~ 5(격렬함/폭발적)
- cards: 품질 우선. 5막 작품 기준 15~30장 권장. 무리해서 채우지 말 것.
- language: 한국어
